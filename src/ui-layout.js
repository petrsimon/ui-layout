...
angular.module('ui.layout', [])
  .controller('uiLayoutCtrl', LayoutCtrl)
  .directive('uiLayout', LayoutDirective)
  .directive('uiSplitbar', SplitbarDirective)
  .directive('uiLayoutContainer', ContainerDirective)
  .directive('uiLayoutLoaded', LoadedDirective)
  .factory('LayoutContainer', ContainerFactory)
 ...
 * @ngInject
 */
function LayoutCtrl($scope, $attrs, $element, $timeout, $window, LayoutContainer, Layout) {
 ...
 *
 * @param $window
 * @returns {{restrict: string, controller: string, link: link}}
 * @constructor
 * @ngInject
 */
function LayoutDirective($window) {
  return {
    restrict: 'AE',
 ...
 *
 * @param LayoutContainer
 * @returns {{restrict: string, require: string, scope: {}, link: link}}
 * @constructor
 * @ngInject
 */
function SplitbarDirective(LayoutContainer) {
  // Get all the page.
 ...
 * @param $compile
 * @param Layout
 * @returns {{restrict: string, require: string, scope: {collapsed: string, resizable: string, size: string, minSize: string, maxSize: string}, compile: compile}}
 * @constructor
 * @ngInject
 */
function ContainerDirective(LayoutContainer, $compile, Layout) {
  return {
    restrict: 'AE',
    require: '^uiLayout',
    scope: {
 ...
 *
 * @param Layout
 * @returns {{require: string, restrict: string, priority: number, link: link}}
 * @constructor
 * @ngInject
 */
function LoadedDirective(Layout) {
 ...
 * @param $q
 * @param $timeout
 * @returns {{addLayout: addLayout, addCollapsed: addCollapsed, hasCollapsed: hasCollapsed, toggled: toggled, toggle: toggle}}
 * @constructor
 * @ngInject
 */
function LayoutFactory($q, $timeout) {
  var layouts = [],
    collapsing = [],
    toBeCollapsed = 0,
...
/**
 *
 * @returns {{Container: Container, Splitbar: Splitbar, isSplitbar: isSplitbar}}
 * @constructor
 * @ngInject
 */
